  ...
  return (
    <div className="App">
      ...
      <Card>
        ...
        <p><strong>Persona asignada:</strong> Martina Caballero</p>
      ...
      <Card>
        ...
        <p><strong>Persona asignada:</strong> Valentino Caballero</p>
      ...
      <Card>
        ...
        <p><strong>Persona asignada:</strong> Marcelo Caballero</p>
